...
@section('content')
    <div class="card-header py-3">
        <h1 class="m-0 font-weight-bold text-primary text-center">Balance</h1>
    </div>
    <br>
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h3 class="m-0 font-weight-bold text-primary text-center">Listado del balance</h3>
            </div>
            <div class="card-body">
    ...
    @include("js.reportes.reporteBalance")
@endsection
